...
[Here is the complete definition of DefaultPageStrategy](https://github.com/vitejs/vite-plugin-react-pages/blob/main/packages/react-pages/src/node/dynamic-modules/DefaultPageStrategy/index.ts). And [here is an example of using it](/examples/component-library).
