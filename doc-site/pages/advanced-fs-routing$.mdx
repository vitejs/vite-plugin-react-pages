...
> Checkout the complete example [here](https://github.com/vitejs/vite-plugin-react-pages/blob/master/packages/playground/custom-find-pages2/vite.config.ts).
...
[Here is the complete definition](<(https://github.com/vitejs/vite-plugin-react-pages/blob/master/packages/react-pages/src/node/dynamic-modules/DefaultPageStrategy/index.ts)>). And <Link to="/examples/component-library">here is an example of using it</Link>.
