...
> Here is a more useful theme: [vite-pages-theme-doc](https://github.com/vitejs/vite-plugin-react-pages/blob/master/packages/theme-doc/src/index.tsx). Learn more about it in [this guide](/official-theme).
