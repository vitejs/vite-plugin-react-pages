...
> This is an advance guide about how to make a theme by yourself. If there is already themes that meet your needs(.e.g <Link to="/official-theme">the official theme</Link>), you don't need to read this guide now!
...
This is probably [the simplest theme](https://github.com/vitejs/vite-plugin-react-pages/blob/master/packages/playground/basic/pages/_theme.tsx):
...
> Here is a more useful theme: [vite-pages-theme-doc](https://github.com/vitejs/vite-plugin-react-pages/blob/master/packages/theme-doc/src/index.tsx). Learn more about it in <Link to="/official-theme">this guide</Link>.
...
> You can refer to [vite-pages-theme-doc](https://github.com/vitejs/vite-plugin-react-pages/blob/master/packages/theme-doc/src/index.tsx)
