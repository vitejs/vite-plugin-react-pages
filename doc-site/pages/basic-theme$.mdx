...
`vite-pages-theme-basic` provides a nice theme. It should satisfy most users' needs. As an example, this document site is powered by this theme.
...
> You can turn of the auto-generated search box in the theme configs. You can also customize the topbar options area.
