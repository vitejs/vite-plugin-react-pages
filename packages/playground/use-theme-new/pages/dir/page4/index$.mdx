...
This is page4. This is a complicated [mdx](https://mdxjs.com/) page.
...
Code block with syntax highlighing:

```tsx
export function createTheme({ sideMenuData }: Option = {}): ICreateTheme {
  return (pages) => {
